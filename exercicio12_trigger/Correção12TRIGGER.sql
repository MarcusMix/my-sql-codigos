...
DROP DATABASE IF EXISTS DBCLASSIFICACAO1;
CREATE DATABASE DBCLASSIFICACAO1;
USE DBCLASSIFICACAO1;
...
BEGIN 
	...
	-- ATUALIZANDO OS VALORES QUE ESTÃO SAINDO DA TABELA
	IF OLD.IDADE < 10 THEN
		UPDATE CLASSIFICACAO
        SET CRIANCAS = CRIANCAS - 1;
    END IF;
	...
	-- ATUALIZANDO OS VALORES QUE ESTÃO CHEGANDO DA TABELA
	IF NEW.IDADE < 10 THEN
		UPDATE CLASSIFICACAO
        SET CRIANCAS = CRIANCAS + 1;
    END IF;
...
*/
 UPDATE aluno 
         SET idade = 69 where nome = 'ana banana';
